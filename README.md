...
<p align="center">
  <a href="https://upstream-host.invalid/">下载</a> &bull;
...
到 [下载页](https://upstream-host.invalid/) 拿安装包，双击装好后打开：
...
- 不采集、不上传任何数据。两项网络行为：检查更新请求版本清单；「上传诊断报告」需你
  主动点击并确认。
- 内置更新只允许从官方域名（upstream-host.invalid）经 https 下载，下载后强制校验 SHA256 与文件
