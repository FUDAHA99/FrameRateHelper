...
try {
  ...
  $first = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg1 -NowUnix 1786248010 -Sender $orderedSender
  ...
  $beforeDue = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg1 -NowUnix 1786248014 -Sender $orderedSender
  Assert-True ($beforeDue.acknowledged -eq 0 -and $script:OrderCalls.Count -eq 2) 'backoff deadline was ignored'
  $afterDue = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg1 -NowUnix 1786248015 -Sender $orderedSender
  ...
  $lost = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg2 -NowUnix 1786248101 -Sender $lostSender
  ...
  $recovered = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg2 -NowUnix 1786248106 -Sender $duplicateSender
  ...
  $r422 = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg3 -NowUnix 1786248201 -Sender $sender422
  ...
  $conflict = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg4 -NowUnix 1786248301 -Sender $conflictSender
  ...
  $fakeConflict = Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg4 -NowUnix 1786248601 -Sender $fakeIdempotentSender
  ...
  [void](Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg5 -NowUnix 1786248401 -Sender $serverSender)
  ...
  [void](Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg5 -NowUnix 1786248410 -Sender $serverSender)
  Assert-True ($script:ServerCalls -eq 1) '5xx event retried before deadline'
  [void](Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg5 -NowUnix 1786248411 -Sender $serverSender)
  $serverState = Read-DfbTuningOutbox (Get-DfbTuningOutboxPath $cfg5)
  ...
  [void]$worker.AddScript({
    ...
    Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $ConfigPath -MaxEvents 1 -NowUnix 1786248451 -Sender $sender
  ...
  Assert-Throws { Invoke-DfbTuningOutboxFlush 'https://upstream-host.invalid/report/telemetry' $cfg6 -NowUnix 1786248500 -Sender { [pscustomobject]@{ok=$true} } } 'root schema' 'corrupt root schema was accepted'
  ...
  [void](Send-DfbTelemetryEvent 'https://upstream-host.invalid/report/telemetry' $ordinary $cfg7)
  [void](Send-DfbTelemetryEvent 'https://upstream-host.invalid/report/telemetry' $ordinary $cfg7)
  ...
  [void](Send-DfbTelemetryEvent 'https://upstream-host.invalid/report/telemetry' $ordinary $cfg7 -EventId $stableId)
